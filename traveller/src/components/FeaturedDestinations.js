...
import { FaInfoCircle } from 'react-icons/fa'; // Importing icon for details button
    ...
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden transition-transform transform hover:scale-55 hover:shadow-2xl duration-300 ease-in-out  relative">
      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex space-x-2">
          <a
            href={`/search/place/${destination.packageId}`}
          ...
          <Link
            to={`/booking?packageId=${destination.packageId}`} // Redirect to the booking page
